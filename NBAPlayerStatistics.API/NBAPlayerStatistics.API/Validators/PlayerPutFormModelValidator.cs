...
{
    public class PlayerPutFormModelValidator : AbstractValidator<PlayerPutFormModel>
    {
        private readonly IPositionRepository _positionRepository;
        private readonly IClubRepository _clubRepository;

        public PlayerPutFormModelValidator(IPositionRepository positionRepository, IClubRepository clubRepository)
        {
